...
<body class="bg-orange-50/30"> <button data-drawer-target="default-sidebar" data-drawer-toggle="default-sidebar"
    ...
    <aside id="default-sidebar"
        ...
        aria-label="Sidebar">
        <div class="h-full px-4 py-6 overflow-y-auto bg-orange-500 border-r border-orange-600 shadow-sm">

            <div class="flex items-center mb-10 px-2">
                <div class="p-2 bg-white rounded-xl shadow-lg shadow-orange-200">
                    <img src="{{ asset('images/logobuku.png') }}" class="w-9" alt="">
                </div>
            ...
            <ul class="space-y-2 font-medium flex-1">
                <li>
                    <a href="{{ route('petugasDashboard') }}"
                        class="flex items-center p-3 text-slate-800 rounded-xl hover:bg-orange-50 hover:text-orange-600 transition-all duration-200 group {{ request()->routeIs('petugasDashboard') ? 'bg-orange-50 text-orange-600 border border-orange-100' : '' }}">
                ...
                <li>
                    <a href="{{ route('buku.index') }}"
                        class="flex items-center p-3 text-slate-800 rounded-xl hover:bg-orange-50 hover:text-orange-600 transition-all duration-200 group {{ request()->routeIs('buku.*') ? 'bg-orange-50 text-orange-600 border border-orange-100' : '' }}">
                        <svg class="w-5 h-5 transition duration-75 group-hover:text-orange-500" fill="none"
                            stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <li>
                    <a href="{{ route('petugasPeminjaman') }}"
                        class="flex items-center p-3 text-slate-800 rounded-xl hover:bg-orange-50 hover:text-orange-600 transition-all duration-200 group">
                        <svg class="w-5 h-5 transition duration-75 group-hover:text-orange-500" fill="none"
                            stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <div class="pt-4 mt-4 border-t border-orange-50">
                ...
                <div class="mt-22">
                    <form action="{{ route('logout') }}" method="POST">
                        @csrf
                        <button type="submit"
                            class="w-full flex items-center p-3 text-slate-800 rounded-xl hover:bg-red-50 hover:text-red-600 transition-all duration-200 group">
